...
<img src="../img/fundoAuth.svg" alt="Fundo do site" class="background-svg">
  <div class="container">
    ...
    <h2>Login Cantineiro</h2>
    <p class="sub-text">Para acessar, é necessário que sua conta tenha sido cadastrada previamente pela escola.
    </p>
